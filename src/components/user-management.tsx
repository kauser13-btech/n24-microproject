        ...
        <form action={action} className="space-y-4">
            ...
            <div className="space-y-2">
                ...
                <select
                    name="role"
                    id="role"
                    className="flex h-10 w-full text-slate-900 rounded-md border border-slate-200 bg-white px-3 py-2 text-sm ring-offset-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-950 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                    defaultValue="admin"
                >
